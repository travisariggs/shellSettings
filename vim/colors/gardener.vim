...
hi Normal guifg=#ffffff guibg=#332211 guisp=#332211 gui=NONE ctermfg=15 ctermbg=52 cterm=NONE
...
hi SpecialComment guifg=#dddddd guibg=#334455 guisp=#334455 gui=italic ctermfg=253 ctermbg=240 cterm=NONE
hi Typedef guifg=#99cc99 guibg=#332211 guisp=#332211 gui=italic ctermfg=151 ctermbg=52 cterm=NONE
hi Title guifg=#ffffff guibg=#445566 guisp=#445566 gui=bold ctermfg=15 ctermbg=60 cterm=bold
hi PreCondit guifg=#99cc99 guibg=#332211 guisp=#332211 gui=bold ctermfg=151 ctermbg=52 cterm=bold
hi Include guifg=#99cc99 guibg=#332211 guisp=#332211 gui=bold ctermfg=151 ctermbg=52 cterm=bold
hi StatusLineNC guifg=#000000 guibg=#ffeecc guisp=#ffeecc gui=NONE ctermfg=NONE ctermbg=230 cterm=NONE
...
hi ErrorMsg guifg=#ff0000 guibg=#332211 guisp=#332211 gui=bold ctermfg=196 ctermbg=52 cterm=bold
hi Ignore guifg=#cccccc guibg=#332211 guisp=#332211 gui=italic ctermfg=252 ctermbg=52 cterm=NONE
hi Debug guifg=#ff9999 guibg=#332211 guisp=#332211 gui=NONE ctermfg=210 ctermbg=52 cterm=NONE
hi PMenuSbar guifg=NONE guibg=#262626 guisp=#262626 gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
hi Identifier guifg=#ffddaa guibg=#332211 guisp=#332211 gui=NONE ctermfg=223 ctermbg=52 cterm=NONE
hi SpecialChar guifg=#bbddff guibg=#332211 guisp=#332211 gui=bold ctermfg=153 ctermbg=52 cterm=bold
hi Conditional guifg=#aadd55 guibg=#332211 guisp=#332211 gui=bold ctermfg=149 ctermbg=52 cterm=bold
hi StorageClass guifg=#99cc99 guibg=#332211 guisp=#332211 gui=bold ctermfg=151 ctermbg=52 cterm=bold
hi Todo guifg=#ff0000 guibg=#556677 guisp=#556677 gui=bold ctermfg=196 ctermbg=60 cterm=bold
hi Special guifg=#bbddff guibg=#332211 guisp=#332211 gui=bold ctermfg=153 ctermbg=52 cterm=bold
hi LineNr guifg=#808080 guibg=#000000 guisp=#000000 gui=bold ctermfg=8 ctermbg=NONE cterm=bold
hi StatusLine guifg=#ffffff guibg=#cc4455 guisp=#cc4455 gui=bold ctermfg=15 ctermbg=167 cterm=bold
hi Label guifg=#ffccff guibg=#332211 guisp=#332211 gui=bold ctermfg=225 ctermbg=52 cterm=bold
hi PMenuSel guifg=#ffffff guibg=#cc4455 guisp=#cc4455 gui=NONE ctermfg=15 ctermbg=167 cterm=NONE
hi Delimiter guifg=#ffffff guibg=#332211 guisp=#332211 gui=bold ctermfg=15 ctermbg=52 cterm=bold
hi Statement guifg=#ffffcc guibg=#332211 guisp=#332211 gui=bold ctermfg=230 ctermbg=52 cterm=bold
hi Comment guifg=#dddddd guibg=#334455 guisp=#334455 gui=NONE ctermfg=253 ctermbg=240 cterm=NONE
hi Character guifg=#ffffcc guibg=#332211 guisp=#332211 gui=bold ctermfg=230 ctermbg=52 cterm=bold
hi Float guifg=#bbddff guibg=#332211 guisp=#332211 gui=bold ctermfg=153 ctermbg=52 cterm=bold
hi Number guifg=#bbddff guibg=#332211 guisp=#332211 gui=bold ctermfg=153 ctermbg=52 cterm=bold
hi Boolean guifg=#ff55ff guibg=#332211 guisp=#332211 gui=bold ctermfg=207 ctermbg=52 cterm=bold
hi Operator guifg=#cc9966 guibg=#332211 guisp=#332211 gui=bold ctermfg=173 ctermbg=52 cterm=bold
hi Question guifg=#ccffcc guibg=#332211 guisp=#332211 gui=bold ctermfg=194 ctermbg=52 cterm=bold
hi WarningMsg guifg=#ff0000 guibg=#332211 guisp=#332211 gui=bold ctermfg=196 ctermbg=52 cterm=bold
hi DiffDelete guifg=#ffffff guibg=#884444 guisp=#884444 gui=NONE ctermfg=15 ctermbg=95 cterm=NONE
hi ModeMsg guifg=#ffeecc guibg=#332211 guisp=#332211 gui=NONE ctermfg=230 ctermbg=52 cterm=NONE
hi Define guifg=#66ccdd guibg=#332211 guisp=#332211 gui=bold ctermfg=80 ctermbg=52 cterm=bold
hi Function guifg=#ffffaa guibg=#332211 guisp=#332211 gui=bold ctermfg=229 ctermbg=52 cterm=bold
hi PreProc guifg=#ffcc99 guibg=#332211 guisp=#332211 gui=bold ctermfg=223 ctermbg=52 cterm=bold
hi Visual guifg=#ffffff guibg=#557799 guisp=#557799 gui=NONE ctermfg=15 ctermbg=67 cterm=NONE
hi MoreMsg guifg=#ffeecc guibg=#332211 guisp=#332211 gui=NONE ctermfg=230 ctermbg=52 cterm=NONE
hi VertSplit guifg=#000000 guibg=#ffeecc guisp=#ffeecc gui=NONE ctermfg=NONE ctermbg=230 cterm=NONE
hi Exception guifg=#66ffcc guibg=#332211 guisp=#332211 gui=bold ctermfg=86 ctermbg=52 cterm=bold
hi Keyword guifg=#66ffcc guibg=#332211 guisp=#332211 gui=bold ctermfg=86 ctermbg=52 cterm=bold
hi Type guifg=#ccffaa guibg=#332211 guisp=#332211 gui=bold ctermfg=193 ctermbg=52 cterm=bold
...
hi PMenu guifg=#000000 guibg=#ffeecc guisp=#ffeecc gui=NONE ctermfg=NONE ctermbg=230 cterm=NONE
hi SpecialKey guifg=#ffffff guibg=#332211 guisp=#332211 gui=NONE ctermfg=15 ctermbg=52 cterm=NONE
hi Constant guifg=#ffffff guibg=#332211 guisp=#332211 gui=bold ctermfg=15 ctermbg=52 cterm=bold
hi Tag guifg=#bbddff guibg=#332211 guisp=#332211 gui=bold ctermfg=153 ctermbg=52 cterm=bold
hi String guifg=#ffffcc guibg=#332211 guisp=#332211 gui=NONE ctermfg=230 ctermbg=52 cterm=NONE
hi PMenuThumb guifg=NONE guibg=#808080 guisp=#808080 gui=NONE ctermfg=NONE ctermbg=8 cterm=NONE
hi Repeat guifg=#ff9900 guibg=#332211 guisp=#332211 gui=bold ctermfg=208 ctermbg=52 cterm=bold
hi Directory guifg=#337700 guibg=#332211 guisp=#332211 gui=NONE ctermfg=2 ctermbg=52 cterm=NONE
hi Structure guifg=#99ff99 guibg=#332211 guisp=#332211 gui=bold ctermfg=120 ctermbg=52 cterm=bold
hi Macro guifg=#99cc99 guibg=#332211 guisp=#332211 gui=bold ctermfg=151 ctermbg=52 cterm=bold
hi Underlined guifg=#99ccff guibg=#332211 guisp=#332211 gui=underline ctermfg=153 ctermbg=52 cterm=underline
